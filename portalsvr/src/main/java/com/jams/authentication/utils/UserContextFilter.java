package com.jams.authentication.utils;
...
public class UserContextFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        System.out.println("****** I am entering the authentication service id with auth token: " + httpServletRequest.getHeader("Authorization"));
